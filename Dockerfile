...
RUN dnf install -y python2 python3 vim java-latest-openjdk.x86_64 maven git wget curl nc jq xmlstarlet colordiff libcouchbase3 libcouchbase-devel libcouchbase3-tools cmake gcc-c++ gcc make openssl-devel zip
